...
#
# Example: Sorted and Grouped CSV BOM for Electronic Cats
#
# Modified for Electronic Cats by Andres Sabas
#
# 7 April 2022
#
#
"""
    ...
    Grouped By: Value
    Sorted By: Ref
    Fields: Item, Qty, Reference(s), Value, Datasheet, all additional symbol fields

    Outputs ungrouped components first, then outputs grouped components.

    Command line:
    python "pathToFile/bom_csv_grouped_by_value_cat.py" "%I" "%O.csv"
"""
